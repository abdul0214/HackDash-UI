...
export default () => {
  return (
    <>
      <section
        className="section-header overflow-hidden pt-2 pt-lg-4 pb-9 pb-lg-12 bg-color-light"
        id="home"
      >
        <Container>
          <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
            <Col className="d-block mb-2 mt-0 mb-md-0">
              ...
              <p className="mb-0">Overview of Hackathon</p>
            </Col>
          </Row>
          <Row className="justify-content-md-center">
            <Col xs={12} sm={6} xl={3} className="mb-4">
              <SimpleCard title="Unresolved" value="15" />
            </Col>

            <Col xs={12} sm={6} xl={3} className="mb-4">
              <SimpleCard title="Overdue" value="17" />
            </Col>

            <Col xs={12} sm={6} xl={3} className="mb-4">
              <SimpleCard title="Resolved" value="35" />
            </Col>

            <Col xs={12} sm={6} xl={3} className="mb-4">
              <SimpleCard title="Archived" value="64" />
            </Col>
          </Row>
